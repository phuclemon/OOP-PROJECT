...
namespace QLSINHVIEN.BLL
{
    class Bll_SinhVien
    {
        ...
        public void bllThem()
        {
            dalSinhVien.dalThem(SV.txt_MaSV.Text, SV.txt_TenSV.Text, SV.NgaySinh.Value, int.Parse(SV.txt_SDT.Text), SV.cb_Lop.SelectedValue.ToString());
        }
        public void bllSua()
        {
            dalSinhVien.dalSua(SV.txt_TenSV.Text, SV.NgaySinh.Value, int.Parse(SV.txt_SDT.Text), SV.cb_Lop.SelectedValue.ToString(), SV.txt_MaSV.Text);
        }
        public void bllXoa()
        {
